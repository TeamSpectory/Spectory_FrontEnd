...
class ArchivingFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        archiveDatas.apply {
            ...
            add(ArchiveData("22.01.23~22.01.26",R.drawable.profile,"3.0","프로젝트","직무역량","성격 및 가치관","협업 경험","동아리","앱 프로젝트","주도적 참여"))
            add(ArchiveData("22.01.23~22.01.26",R.drawable.profile,"1.0","스펙토리","직무역량","성격 및 가치관","협업 경험","동아리","앱 프로젝트","주도적 참여"))
